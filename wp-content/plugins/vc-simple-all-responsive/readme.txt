=== WPBakery Page Builder (formerly Visual Composer) Simple All Responsive ===
Plugin Name: VC Simple All Responsive
Contributors: autonomash
Tags: WPBakery, Page Builder, Visual Composer, responsive
...
VC Simple All Responsive makes it easier to develop responsive websites when using WPBakery (former Visual Composer) Page Builder. Works on elements within columns.
