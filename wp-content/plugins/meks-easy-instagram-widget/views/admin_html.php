...
<?php if($this->is_authorized()):?>
	<p>
		<label for="<?php echo $this->get_field_id( 'username_hashtag' ); ?>"><?php _e( 'Your Instagram username', 'meks-easy-instagram-widget' ); ?>:</label> 
		...
		<small class="howto"><?php _e( 'Authorized users can use their own account only.', 'meks-easy-instagram-widget' ); ?></small>
	</p>
<?php else: ?>
	<p>
...
<p>
	...
	<small class="howto"><?php _e( 'Specify a text for your "follow" link, or leave empty if you do not want to display the "follow" link', 'meks-easy-instagram-widget' ); ?></small>
</p>